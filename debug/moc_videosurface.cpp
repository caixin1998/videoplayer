...
QT_MOC_LITERAL(3, 24, 3) // "img"
    ...
    "VideoSurface\0showImage\0\0img"
};
...
void VideoSurface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (VideoSurface::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoSurface::showImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoSurface::showImage(QImage _t1)
{
